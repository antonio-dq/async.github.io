...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            {
                name: 'Insta',
                link: 'https://www.instagram.com/async_dev.lua/'
            },
            
            {
                name: 'Discord',
                link: 'https://discord.gg/FFJfp7Nxhx'
            },
    ...
    (function () {
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[async.web]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'>async#1312 and async.#2611</i>"], 120, 500, function () {
